...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.7\linewidth]{Rozpraszanie-Ramanowskie-Ciekie/piki.pdf}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.6\linewidth]{Rozpraszanie-Ramanowskie-Ciekie/Phonons_opposite.png}
		\caption{Niebieski: pik ramanowski dla niecienkich warstw. Czerwony: pik ramanowski dla cienkich warstw.}
	\end{center}
\end{figure}
