...
\begin{thebibliography}{}
	\bibitem{litlink1} Cezariusz Jastrzębski, Daniel J. Jastrzebski, Vitali Kozak, Karolina Pietak, Wojciech Gebicki $"$Synthesis and structural characterization of thin $\mathbf{Ga_{2}S_{3}}$ layers on semiconducting $\mathbf{GaP}$ substrate$"$, złożone do Journal: Materials Science in Semiconductor Processing.
